/**
 * Deploy MembershipRegistry to Redbelly testnet.
 * Run from project root: npx hardhat compile && node scripts/deploy.js
 * Requires .env: RPC_URL, DEPLOYER_PRIVATE_KEY, BACKEND_ADDRESS, DAO_ADDRESS (optional; defaults to BACKEND_ADDRESS)
 */
